...
const Contact = () => {
    ...
    const renderForm = () => {
        switch (status) {
            ...
            case 'success':
                return (
                    <div className='text-secondary'>Your message has been sent successfully!</div>
                );
            case 'error':
                return (
            ...
            <div className={styles.contactDiv}>
                <Row>
                    ...
                    <Col sm='12' md='6'>
                        ...
                        <div className={styles.underLine}></div>
                        <div>
                            Feel free to send me a message or connect with me through social
                            networking platforms. Whether you want to talk about a project
                            collaboration, or just get in touch with me, I'd love to hear from you!
                        </div>
